...
export START_COMMIT="25833e540d305d8fe6dff456a62eb1417e04a372"
export RELEASE_CUSTOM_HOOK=release_custom_hook
export REPO_NAME=storiesofgaatha/gaatha-server
export DEFAULT_BRANCH=develop
export VERSION_TAG_PREFIX_MODE=require

export GIT_CLIFF__REMOTE__GITHUB__OWNER=storiesofgaatha
export GIT_CLIFF__REMOTE__GITHUB__REPO=gaatha-server
